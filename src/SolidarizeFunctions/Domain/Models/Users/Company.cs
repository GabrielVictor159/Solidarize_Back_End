...
{
    public Company(string companyName, string images, string icon, string description, int legalNature, string locationX, string locationY, bool banned, DateTime? banDate, DateTime? creationDate, DateTime? lastAccessDate, string cnpj, string address, 
